...
let NotificationController = class NotificationController {
    ...
    async getNotifications(req, limit = 20, skip = 0) {
        return this.notificationService.getNotifications(req.user.sub, limit, skip);
    }
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Obtenir mes notifications non lues' }),
    __param(0, (0, common_1.Request)()),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Obtenir le nombre de notifications non lues' }),
    __param(0, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
