...
export declare const MedicationRequestSchema: import("mongoose").Schema<MedicationRequest, import("mongoose").Model<MedicationRequest, any, any, any, Document<unknown, any, MedicationRequest, any, {}> & MedicationRequest & Required<{
    ...
    __v: number;
}, any>, {}, {}, {}, {}, import("mongoose").DefaultSchemaOptions, MedicationRequest, Document<unknown, {}, import("mongoose").FlatRecord<MedicationRequest>, {}, import("mongoose").DefaultSchemaOptions> & import("mongoose").FlatRecord<MedicationRequest> & Required<{
    _id: import("mongoose").Types.ObjectId;
}> & {
    __v: number;
}>;
