...
export declare const PharmacyProfileSchema: import("mongoose").Schema<PharmacyProfile, import("mongoose").Model<PharmacyProfile, any, any, any, Document<unknown, any, PharmacyProfile, any, {}> & PharmacyProfile & {
    ...
    __v: number;
}, any>, {}, {}, {}, {}, import("mongoose").DefaultSchemaOptions, PharmacyProfile, Document<unknown, {}, import("mongoose").FlatRecord<PharmacyProfile>, {}, import("mongoose").DefaultSchemaOptions> & import("mongoose").FlatRecord<PharmacyProfile> & {
    _id: Types.ObjectId;
} & {
    __v: number;
}>;
